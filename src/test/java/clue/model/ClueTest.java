...
class ClueTest {
    ...
    void testIfCanCreateAClueBasedOnStringsAndDouble(){
        Clue clue1 = new Clue("name1","test1","theme1",new BigDecimal(10.1));
    ...
    @Test
    void getText() {
        Clue clue2 = new Clue("name2","text2","theme2",new BigDecimal(10.1));
    ...
    void getPrice() {
        Clue clue2 = new Clue("name2","text2","theme2",new BigDecimal(10.1));
        assertEquals(new BigDecimal(10.1) ,clue2.getPrice().toBigDecimal());
    }
